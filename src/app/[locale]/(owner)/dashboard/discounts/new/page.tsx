...
import { CreateDiscountForm } from "@/components/owner/CreateDiscountForm";
import { getDiscountFormData } from "@/features/discounts/server";
...
export default async function NewDiscountPage({
  ...
  const { products, customers } = await getDiscountFormData();
  ...
  return (
    <div className="space-y-5">
      ...
      <CreateDiscountForm products={products} customers={customers} />
    </div>
  );
}